...
substring(str1,3,6)=${fn:substring(str1,3,6)} : str1의 3~5번 인덱스 까지 부분 문자열 리턴<br>
substringAfter(str1,str2)=${fn:substringAfter(str1,str2)} : str1의 문자열에서 str2 문자열 이후의 문자열 리턴<br>
